...
description = """
This contains the backend code for the Loopr application. It provides a set of API endpoints for user registration, login, product management, coupon management, and shopping cart functionality.
"""


app = FastAPI(
    title="Loopr Python Assignment",
    description=description,
    version="0.1",
    contact={
        "name": "Arvind Shelke",
        "url": "https://arvindshelke.bio.link",
    },
)
security = HTTPBearer()
pwd_context = CryptContext(schemes=["bcrypt"], deprecated="auto")
SECRET_KEY = "iskochupakerakhnahotaheinbutiamtoolazytodoit"
ALGORITHM = "HS256"
